...
public class StatisticsOptionsPanel extends JPanel implements ActionListener {
	...
	public StatisticsOptionsPanel (DiffallGui diffallGui) {
		m_diffallGui = diffallGui;

		JPanel paneText = new JPanel();
		paneText.setLayout (new BorderLayout());
		paneText.add (new JLabel ("Statistics Options"), BorderLayout.WEST);

		JPanel paneOptions = new JPanel();
		paneOptions.setBorder (new SoftBevelBorder (SoftBevelBorder.LOWERED));

		m_chkGui = new JCheckBox ("Create Statistics");
		m_chkGui.setSelected (false);
		m_chkGui.setToolTipText ("Create Statistics in the file.");
	...
	public class Options {
		public boolean isStatistics() {return m_chkGui.isSelected();}
