...
//		Element elem;
		...
		try{
			...
			for(int i2=0; i2<len2; i2++) {
				...
				if(node2.getNodeType() == Node.ELEMENT_NODE && node2.getNodeName().equals("namebindings:StringNameSpaceBinding")) {
//					LogHelper.info("has child (2) node "+node2.getNodeName());
					...
					String str3 = getAttrValue ("stringToBind", node2);
					makeCmd (str1, str2, str3);
				}
			}
		}
		catch(Exception ex) {
	...
	private void makeCmd (String s1, String s2, String s3) {
		String str1 = s1;
		if(s2.equals(s1)) str1 = "";
		StringBuffer sb = new StringBuffer();
		sb.append("JVaddNSBString $cellName ");
