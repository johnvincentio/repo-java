 ...
 * saveAs; menu should understand that only certain items can be saved.
 */
public class ExplorerGUI extends JPanel {
	private static final long serialVersionUID = 1L;

	private static final String WORKING_DIRECTORY = "c:/jvWork/jvExplorer";
	public static final String EDITOR = "C:/Program Files (x86)/EditPlus 3/editplus.exe";
	public static final String BROWSER = "C:/Program Files (x86)/Google/Chrome/Application/chrome.exe";
