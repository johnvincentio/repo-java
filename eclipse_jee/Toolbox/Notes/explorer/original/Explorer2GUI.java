 ...
 */
public class Explorer2GUI extends JFrame implements ActionListener {
	...
	public Explorer2GUI (String msg, String[] args) {
		super(msg);
...
//		System.out.println("strWorkDir :"+strWorkDir+":");
		...
		setContentPane (makeContentPane (new File (strFile)));
...
//		setContentPane (makeContentPane (file));
	...
	public static void main(String[] args) {
		new Explorer2GUI("ExplorerGUI", args);
	}
...
*/
		Expander2TreePanel expander2TreePanel = new Expander2TreePanel (this, nodeItemInfo);

		JPanel pane = new JPanel();
		pane.setLayout(new BorderLayout());
		pane.add(topPane,BorderLayout.NORTH);
		pane.add(expander2TreePanel,BorderLayout.CENTER);
