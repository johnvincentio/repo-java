...
public class PlayerInfo {
	private ServerPlayer m_playerThread;	// Player thread
	...
	public PlayerInfo (ServerPlayer player, int key, int place) {
	...
	public ServerPlayer getPlayer() {return m_playerThread;}
	public ScrabbleServerSocket getSocket() {return m_playerThread.getSocket();}
