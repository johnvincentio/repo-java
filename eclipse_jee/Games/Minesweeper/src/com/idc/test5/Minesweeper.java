...
class Minesweeper extends JFrame implements ActionListener, ContainerListener {
    ...
    public void setic() {
        ...
        for (int i = 0; i <= 8; i++) {
            name = i + ".gif";
            ic[i] = new ImageIcon("other_gifs/"+name);
        }
        ic[9] = new ImageIcon("other_gifs/mine.gif");
        ic[10] = new ImageIcon("other_gifs/flag.gif");
        ic[11] = new ImageIcon("other_gifs/new game.gif");
        ic[12] = new ImageIcon("other_gifs/crape.gif");
    }
