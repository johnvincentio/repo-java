...
public class MineSweeper extends JFrame implements ActionListener, ContainerListener {
	...
	int fw, fh, blockr, blockc, var1, var2, num_of_mine, detectedmine = 0,
			savedlevel = 1, savedblockr, savedblockc, savednum_of_mine = 10;
							...
							for (int k = 0; k < blockr; k++) {
								for (int l = 0; l < blockc; l++) {
									if (countmine[k][l] == -1) {
										...
										// blocks[k][l].setFont(new
										// Font("",Font.CENTER_BASELINE,8));
										blocks[k][l].removeMouseListener(mh);
									}
									blocks[k][l].removeMouseListener(mh);
								}
