...
public class XmlDataSourceApp
{
	...
	public static void main(String[] args) {
		...
		*/
		...
		fileName = "C:/irac7/wrkspc/Pdf/Jasper1/CustomersReport.jrxml";

		//Compile time : 1719
		taskName = TASK_COMPILE;
		fileName = "C:/irac7/wrkspc/Pdf/Jasper1/OrdersReport.jrxml";

		//Filling time : 9219
		taskName = TASK_FILL;
		fileName = "CustomersReport.jasper";

		//PDF creation time : 2531
		taskName = TASK_PDF;
		fileName = "CustomersReport.jrprint";
		...
		try
		{
			...
			else if (TASK_FILL.equals(taskName))
			{
				...
				Document document = JRXmlUtils.parse(JRLoader.getLocationInputStream("C:/irac7/wrkspc/Pdf/Jasper1/northwind.xml"));
