...
//    RI014	    DTC2051	    01/09/07     SR39459             Website re-write support.
//    RI015	    DTC9028	    01/08/08     SR39459             Changed max records per page from 10000 to 100.
//    VB016     DTC2073     09/05/08     SR44922             E-Trieve Websphere Fix Pack - Remove word servlet from URL
//    VB017     DTP0056     10/17/08     TT-IN6261           Passing parameter to menu
//									     TT-IN9252
// ****************************************************************************************************************

// RI014	String[]    names = session.getValueNames();		 
// RI014	if ( names.length <= 0 || names[0] == "")
// RI014	  response.sendRedirect("securityFailure.jsp");

Enumeration enum = session.getAttributeNames();		// RI014

if (!enum.hasMoreElements())	// RI014
	response.sendRedirect("securityFailure.jsp");	// RI014
...
<%
String str_username    = (String) session.getAttribute("username");		// RI014
String str_customer    = (String) session.getAttribute("customer");		// RI014
String str_company     = (String) session.getAttribute("company");		// RI014
String str_companyname = (String) session.getAttribute("companyname");	// RI014
String str_datalib     = (String) session.getAttribute("datalib");		// RI014
String list_customer   = (String) session.getAttribute("list");			// RI014
String str_password    = (String) session.getAttribute("password");		// RI014
String str_as400url    = (String) session.getAttribute("as400url");		// RI014
String str_as400driver = (String) session.getAttribute("as400driver");	// RI014
String loginuserid     = (String) session.getAttribute("loginuserid");	// RI014
...
MenuSecurityBeanconnection = MenuSecurityBean.makeautoConnection(str_as400driver, str_as400url, str_username, str_password, str_GoldCountry, str_connType);		// RI014

if(!MenuSecurityBean.isUserAuthorized(str_company, str_datalib, str_userid, "U84") && str_agebucket.equals("") )
{
	//VB017	response.sendRedirect("menu.jsp");
      response.sendRedirect("menu.jsp?showReports=1");   // VB017
}
...
<BODY BGCOLOR="#ffffff">
	...
	<div ID=maintext>
		...
		<center>
			...
			<table border="0" width="650" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<!-- VB017 -->		<!-- <td align="right" class="history"><a href='menu.jsp'>report menu</a>&nbsp;&nbsp;&nbsp;open invoices&nbsp;&nbsp;&nbsp;</td> -->
                    <td align="right" class="history"><a href='menu.jsp?showReports=1'>report menu</a>&nbsp;&nbsp;&nbsp;open invoices&nbsp;&nbsp;&nbsp;</td>   <!-- VB017 -->
					<td></td>
				</tr>
			</table>
		...
		openinvoicebeanconnection = openinvoicebean.makeautoConnection(str_as400driver, str_as400url, str_username, str_password, str_GoldCountry, str_connType);	// RI014
			...
			%>
						...
						<tr>
							<form action="contractDetail.jsp" method=POST>
								...
								<input type="hidden" name="sequence" value="<%=str_sequence%>">
								<td bgcolor="<%=str_color%>" background="images/empty.gif" align="right" valign="top" class="tabledata"><a href="contractDetail.jsp?contract=<%=str_contract%>&sequence=<%=str_sequence%>" onClick="submit();"><%=str_contract%>-<%=str_sequence%></a></td>
							</form>
      ...
      <!-- VB017 -->   <!--  <a href="menu.jsp"><IMG src="images/menu.gif" height="40" width="62" border="0"></a> -->
      <a href="menu.jsp?showReports=1"><IMG src="images/menu.gif" height="40" width="62" border="0"></a>     <!-- VB017 --> 
