...
//    RI014	    DTC9028	    01/08/08     SR39459             Changed max records per page from 500 to 100.
...
MenuSecurityBeanconnection = MenuSecurityBean.makeautoConnection(str_as400driver, str_as400url, str_username, str_password, str_GoldCountry, str_connType);		// RI013

if(!MenuSecurityBean.isUserAuthorized(str_company, str_datalib, str_userid, "U08"))
{
	//VB016	response.sendRedirect("menu.jsp");
      response.sendRedirect("menu.jsp?showReports=1");   // VB016
}
	...
	<div ID=maintext>
		...
		<table border="0" width="900" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<!-- VB016 -->	<!-- <td align="right" class="history"><a href='menu.jsp'>report menu</a>&nbsp;&nbsp;&nbsp;rental history by equipment type&nbsp;&nbsp;&nbsp;</td> -->
                <td align="right" class="history"><a href='menu.jsp?showReports=1'>report menu</a>&nbsp;&nbsp;&nbsp;rental history by equipment type&nbsp;&nbsp;&nbsp;</td>  <!-- VB016 -->
				<td></td>
			</tr>
		</table>
