...
import com.hertz.hercutil.rentalman.data.RMNarpDataItemInfo;
...
public class RMAccountInfo implements RMAccountType, Serializable {
	...
	public RMAccountInfo (RMAccountDataItemInfo rmAccountDataItemInfo) {
		this.account = rmAccountDataItemInfo.getAccount();
		this.countryCode = rmAccountDataItemInfo.getCountryCode();
		this.business = rmAccountDataItemInfo.getBusiness();
		this.address1 = rmAccountDataItemInfo.getAddress1();
		this.address2 = rmAccountDataItemInfo.getAddress2();
		this.city = rmAccountDataItemInfo.getCity();
		this.state = rmAccountDataItemInfo.getState();
		this.zip = rmAccountDataItemInfo.getZip();
		this.lastActivityDate = rmAccountDataItemInfo.getLastActivity();		
	}
	public RMAccountInfo (RMNarpDataItemInfo rmNarpDataItemInfo) {
		this.account = rmNarpDataItemInfo.getNarp();
		this.countryCode = rmNarpDataItemInfo.getCountryCode();
		this.business = rmNarpDataItemInfo.getBusiness();
		this.address1 = rmNarpDataItemInfo.getAddress1();
		this.address2 = rmNarpDataItemInfo.getAddress2();
		this.city = rmNarpDataItemInfo.getCity();
		this.state = rmNarpDataItemInfo.getState();
		this.zip = rmNarpDataItemInfo.getZip();
		this.lastActivityDate = rmNarpDataItemInfo.getLastActivity();		
	}
