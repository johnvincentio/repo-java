...
public class RMNarpAccountInfo implements RMAccountType, Serializable {
	...
	public RMNarpAccountInfo (RMNarpDataItemInfo rmNarpDataItemInfo, RMAccountDataItemInfo rmCorpLinkAccountDataItemInfo,
			RMAccountDataInfo rmAccountDataInfo) {
		this.rmNarpAccountInfo = new RMAccountInfo(rmNarpDataItemInfo);
		this.rmCorpLinkAccountInfo = new RMAccountInfo(rmCorpLinkAccountDataItemInfo);
		this.rmAccountsInfo = new RMAccountsInfo(rmAccountDataInfo);
	}
