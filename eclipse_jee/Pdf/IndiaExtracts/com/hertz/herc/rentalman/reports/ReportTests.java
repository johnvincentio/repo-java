...
import com.hertz.hercutil.rentalman.reports.CSVTemplateInfo;
...
public class ReportTests extends TestCase {
	...
	public void testPhase1a() {
		...
		CSVTemplateInfo csvTemplateInfo = getCSVTemplate (true);
		try {
			...
			StringBuffer buf = CSVTemplateHelper.getEquipmentHistory (csvTemplateInfo, equipmentHistoryInfo);
			assertNotNull (buf);
		}
	...
	public void testPhase2a() {
		...
		try {
			...
			StringBuffer buf = CSVTemplateHelper.getEquipmentDetailHistory (csvTemplateInfo, equipmentDetailHistoryInfo);
			assertNotNull (buf);
	...
	private CSVTemplateInfo getCSVTemplate (boolean header) {
		CSVTemplateInfo csvTemplateInfo = new CSVTemplateInfo (header);
		csvTemplateInfo.add (true); csvTemplateInfo.add (true);	csvTemplateInfo.add (true); csvTemplateInfo.add (true);
		csvTemplateInfo.add (true); csvTemplateInfo.add (true);	csvTemplateInfo.add (true); csvTemplateInfo.add (true);
		csvTemplateInfo.add (true); csvTemplateInfo.add (true);	csvTemplateInfo.add (true); csvTemplateInfo.add (true);
		csvTemplateInfo.add (true); csvTemplateInfo.add (true);	csvTemplateInfo.add (true); csvTemplateInfo.add (true);
		csvTemplateInfo.add (true); csvTemplateInfo.add (true);	csvTemplateInfo.add (true); csvTemplateInfo.add (true);
	...
	private CSVTemplateInfo getCSVTemplate2 (boolean header) {
		CSVTemplateInfo csvTemplateInfo = new CSVTemplateInfo (header);
		csvTemplateInfo.add (true); csvTemplateInfo.add (true);	csvTemplateInfo.add (true); csvTemplateInfo.add (true);
		csvTemplateInfo.add (true); csvTemplateInfo.add (false); csvTemplateInfo.add (true); csvTemplateInfo.add (true);
		csvTemplateInfo.add (true); csvTemplateInfo.add (false); csvTemplateInfo.add (true); csvTemplateInfo.add (true);
		csvTemplateInfo.add (true); csvTemplateInfo.add (false); csvTemplateInfo.add (true); csvTemplateInfo.add (true);
		csvTemplateInfo.add (true); csvTemplateInfo.add (false); csvTemplateInfo.add (true); csvTemplateInfo.add (true);
		csvTemplateInfo.add (true); csvTemplateInfo.add (false); csvTemplateInfo.add (true); csvTemplateInfo.add (true);
