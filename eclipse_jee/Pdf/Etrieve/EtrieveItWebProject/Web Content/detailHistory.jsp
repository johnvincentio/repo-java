	...
	<div ID=maintext>
		...
		<table border="0" width="900" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="right" class="history"><a href='menu.jsp'>main menu</a>&nbsp;&nbsp;&nbsp;detail history&nbsp;&nbsp;&nbsp;</td>
				<td></td>
			</tr>
		...
		detailhistorybeanconnection = detailhistorybean.makeautoConnection(str_as400driver, str_as400url, str_username, str_password);
